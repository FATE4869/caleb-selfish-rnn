...
def main(seed):
    ...
    args.lr = 40
    args.redistribution = 'none'
    args.save = f'{seed}.pt'
    args.sparse = True
    sparse_init = 'uniform'
    # args.evaluate = 'models/stacked_LSTM/___e5___111.pt'
            ...
            for epoch in range(1, args.epochs + 1):
                ...
                if 't0' in optimizer.param_groups[0]:
                    ...
                    if val_loss2 < stored_loss:
                        ...
                        model_save(args.save, epoch=epoch)
